...
import { Check, Plus, X, Search, Wifi, Car, Snowflake, Thermometer, Bath, Zap, Lightbulb, AirVent, Music, Mic, Camera, Projector, Tv, Router, Phone, Printer, ChefHat, Utensils, IceCream, UtensilsCrossed, Coffee, Wine, Gift, Star, Heart, Gamepad2, Waves, Dumbbell, Sun, Sofa, TreePine, Bed, MapPin, Square, Shirt, Shield, Eye, Lock, Activity, Baby, Volume2, Bus, Plane, Bike, Flower2, Moon, Crown, Gem, Award, Sparkles } from 'lucide-react';
...
export function AmenitiesPicker({ amenities, onChange }: AmenitiesPickerProps) {
      ...
      <Card>
        ...
        <CardContent>
          <Tabs value={activeCategory} onValueChange={setActiveCategory}>
            ...
            {Object.entries(filteredAmenities).map(([category, categoryAmenities]) => (
