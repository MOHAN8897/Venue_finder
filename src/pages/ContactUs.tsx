            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">info@venuefinder.com</p>
                  <p className="text-gray-600">support@venuefinder.com</p>
                </div>
              </div>
            ...
            <div className="mt-12">
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <h4 className="font-medium text-gray-900 mb-2">How do I book a venue?</h4>
                  <p className="text-gray-600 text-sm">
                    Browse our venues, select your preferred one, and use our booking system to reserve your date and time.
                  </p>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm">
                  <h4 className="font-medium text-gray-900 mb-2">Can I list my venue on your platform?</h4>
                  <p className="text-gray-600 text-sm">
