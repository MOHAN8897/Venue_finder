      ...
      <div className="max-w-md w-full space-y-6 sm:space-y-8">
        ...
        {success ? (
          <div className="bg-white p-6 sm:p-8 rounded-lg shadow-md text-center">
            <Mail className="mx-auto h-10 w-10 sm:h-12 sm:w-12 text-green-500" />
            <h3 className="mt-3 sm:mt-4 text-lg sm:text-xl font-semibold text-gray-900">Check Your Email</h3>
            ...
            <button
              ...
              className="mt-4 sm:mt-6 w-full flex justify-center py-3 sm:py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 min-h-[44px]"
            >
              I have the code!
            </button>
          </div>
