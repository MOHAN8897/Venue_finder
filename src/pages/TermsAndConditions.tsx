      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. Venue Listings and Bookings</h2>
              <div className="space-y-4">
                <h3 className="text-xl font-medium text-gray-900 mb-2">4.1 Venue Owners</h3>
                <p className="text-gray-700">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-2">4.2 Venue Renters</h3>
                <p className="text-gray-700">
                ...
                <h3 className="text-xl font-medium text-gray-900 mb-2">4.3 Booking Confirmation</h3>
                <p className="text-gray-700">
